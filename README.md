...
## Conclusions
- Model 1 is a basic model with low validation accuracy and overfitting. 
- Augmentation and dropout is used in model 2 which improved overfitting, but train and validation accuracy were low. Model created become underfitting.
- Model 3 used Augmentor library along with Augmentation and dropout. This resulted in a model with better train and validation accuracy.
